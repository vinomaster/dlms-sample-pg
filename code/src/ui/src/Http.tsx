...
/**
 * AxiosError class used to handle http errors
 *
 * @remarks
 * This provides a wrapper around `AxiosError` to check
 * for a response value if axios returns with an error.
 */
...
/**
 * Http Client class used to make http requests
 *
 * @remarks
 * This class utilizes the `axios` library to make http requests.
 *
 */
export class Http {
    baseUrl: string;
